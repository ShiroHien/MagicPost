      ...
      <div className="bodyCenterInfo">
        <div className="leftInfo">
          ...
          <div className="infoLine">
              ...
              <div>Tên Điểm Tập Kết: <span className="data"> abc </span></div>
            </div>
            <div className="infoLine">
        ...
        <div className="rightUpdate">
          {showEdit &&
            <div className="editContainer">
              <p className="category">Chỉnh sửa thông tin Điểm Tập Kết</p>
              <Form onSubmit={handleEdit}>
                <Col lg="6" sm="3">
                  <div className="label">Tên Điểm Tập Kết</div>
                  <FormGroup>
                    <Input
                      required
                      placeholder=" "
