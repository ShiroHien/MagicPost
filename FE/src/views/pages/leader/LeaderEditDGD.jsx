      ...
      <div className="bodyCenterInfo">
        <div className="leftInfo">
          ...
          <div className="infoLine">
              ...
              <div>Tên Điểm Giao Dịch: <span className="data"> abc </span></div>
            </div>
            <div className="infoLine">
            ...
            <div className="infoLine">
              {/* <div>Khu vực: <span className="data">{data.area}</span></div> */}
              <div>Điểm Tập Kết: <span className="data"> abc </span></div>
            </div>
            <div className="infoLine">
        ...
        <div className="rightUpdate">
          {showEdit &&
            <div className="editContainer">
              <p className="category">Chỉnh sửa thông tin Điểm Giao Dịch</p>
              <Form onSubmit={handleEdit}>
                <Col lg="6" sm="3">
                  <div className="label">Tên Điểm Giao Dịch</div>
                  <FormGroup>
                    <Input
                      required
                      placeholder=" "
