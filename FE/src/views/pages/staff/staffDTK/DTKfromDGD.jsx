  ...
  return (
    <div className='centerList'>
      <div>
        ...
        <Card>
          <CardBody>
          <CardTitle className="my-form-title" >Danh sách đơn hàng nhận từ Điểm Giao Dịch</CardTitle>
          <form onSubmit={handleSubmit}> 
            <Button
                color="danger"
                className="btn-round"
                type="submit">
                Tạo đơn gửi Điểm Tập Kết
            </Button>
      ...
      <Modal isOpen={modal3} toggle={() => setModal3(false)} className="modal-lg">
        <div className="modal-header justify-content-center">
          <h4 className="title title-up">
            Danh sách đơn gửi từ Điểm Giao Dịch
          </h4>
        </div>
        <ModalBody>
